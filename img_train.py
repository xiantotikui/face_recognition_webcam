...
dataset_a, dataset_p, dataset_n, _ = generator.generator_triplet_loss(1000, './out_img')
...
train.fit([dataset_a, dataset_p, dataset_n], None, shuffle=True, batch_size=8, epochs=200, callbacks=[save_weights])
